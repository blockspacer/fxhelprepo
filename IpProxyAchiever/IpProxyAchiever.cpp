...
// IpProxyAchiever.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CIpProxyAchieverApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CIpProxyAchieverApp 构造

CIpProxyAchieverApp::CIpProxyAchieverApp()
...
// 唯一的一个 CIpProxyAchieverApp 对象

CIpProxyAchieverApp theApp;


// CIpProxyAchieverApp 初始化

BOOL CIpProxyAchieverApp::InitInstance()
{
...
void CIpProxyAchieverApp::InitAppLog()
{
