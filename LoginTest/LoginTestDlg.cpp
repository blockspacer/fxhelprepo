...
{
    CDialogEx::DoDataExchange(pDX);
    DDX_Control(pDX, IDC_EXPLORER1, explorer_);
}
...
BEGIN_MESSAGE_MAP(CLoginTestDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
    ON_BN_CLICKED(IDC_BUTTON1, &CLoginTestDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
BOOL CLoginTestDlg::OnInitDialog()
{
    ...
    explorer_.Navigate(L"http://www.kugou.com", NULL, NULL, NULL, NULL);
...
void CLoginTestDlg::OnBnClickedButton1()
{
    CString strCookie_one;
    CInternetSession::GetCookie(L"http://www.kugou.com", L"KuGoo", strCookie_one);
}
