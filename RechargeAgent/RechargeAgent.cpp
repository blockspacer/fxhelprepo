...
BEGIN_MESSAGE_MAP(CRechargeAgentApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CRechargeAgentApp 构造
...
// 唯一的一个 CRechargeAgentApp 对象

CRechargeAgentApp theApp;


// CRechargeAgentApp 初始化

BOOL CRechargeAgentApp::InitInstance()
{
