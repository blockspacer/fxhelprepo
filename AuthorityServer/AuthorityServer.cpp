...
// AuthorityServer.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CAuthorityServerApp, CWinApp)
...
// 唯一的一个 CAuthorityServerApp 对象

CAuthorityServerApp theApp;


// CAuthorityServerApp 初始化

BOOL CAuthorityServerApp::InitInstance()
{
