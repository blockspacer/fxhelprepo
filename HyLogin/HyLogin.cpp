...
BEGIN_MESSAGE_MAP(CHyLoginApp, CWinApp)
...
void CHyLoginApp::InitAppLog()
{
    CommandLine::Init(0, NULL);
    base::FilePath path;
    PathService::Get(base::DIR_APP_DATA, &path);
    path = path.Append(L"CHyLoginApp").Append(L"CHyLoginApp.log");
